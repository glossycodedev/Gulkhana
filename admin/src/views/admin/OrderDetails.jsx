...
const OrderDetails = () => {
  ...
  const update_payment = (e) => {
    ...
    console.log("update_payment-1");
    if (orderId) {
      try {
        api.put(`/admin/order-payment-status/confirm/${orderId}`, {
          status_payment: e.target.value,
        });
        console.log("update_payment-2");
        setStatus_payment(e.target.value);
    ...
    <div className="px-2 lg:px-7 pb-5">
      <div className="w-full p-4 bg-[#6a5fdf] rounded-md">
        <div className="flex justify-between items-center p-4">
          <h2 className="text-xl text-[#d0d2d6]">Order Details-1</h2>
          <select
