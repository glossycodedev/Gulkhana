        ...
        <div className=" bg-[#F8F9F9] py-5 mb-5">
          <div className="w-[70%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            <div className="flex justify-start items-center text-md text-slate-600 w-full">
              ...
              <span className="text-[#B65278]">Cart </span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="w-[70%] lg:w-[90%] md:w-[90%] sm:w-[90%] mx-auto py-6">
          {card_products.length > 0 || outofstock_products > 0 ? (
            <div className="flex flex-wrap">
              <div className="w-[67%] md-lg:w-full border">
                <div className="md-lg:pr-0">
                  <div className="flex flex-col gap-3">
                    <div className="w-full bg-[#F8F9F9] ">
                      <h2 className="text-md p-4 text-green-500 font-semibold">
                        Your cart items {card_products.length}
                      </h2>
                    </div>
                    ...
                    {card_products.map((p, i) => (
                      <div key={i} className="flex bg-white p-4 flex-col gap-2">
                        ...
                        {p.products.map((pt, i) => (
                          <div
                            key={i}
                            className="w-full flex flex-wrap border-b"
                          >
                            ...
                            <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                              ...
                              <div className="flex gap-2 flex-col">
                                ...
                                <button
                                  ...
                                  className="px-5 py-[3px] mb-2 bg-red-500 text-white"
                                >
                                  Delete
                                </button>
                              </div>
              ...
              <div className="w-[33%] md-lg:w-full">
                <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                  {card_products.length > 0 && (
                    <div className="bg-[#F8F9F9] p-5 border  text-slate-600 flex flex-col gap-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        />
                        <button className="px-5 py-[1px] bg-[#B65278] text-white rounded-sm uppercase text-sm">
                          Apply
                        </button>
                      </div>
                      ...
                      <button
                        onClick={redirect}
                        className="px-5 py-[8px] rounded-sm hover:bg-[#D871A1] hover:text-white hover:shadow-lg bg-[#B65278] text-sm text-white uppercase "
                      >
            ...
            <div className="flex py-14">
              <h2 className="text-2xl px-4">Cart Is Empty</h2>
              <Link
                className="px-8 py-2 bg-[#B65278] hover:bg-[#D871A1] rounded-sm text-white"
                to="/shops"
              >
                {' '}
                Shop Now
